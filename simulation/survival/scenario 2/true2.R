...
large.df$Ta0[large.df$Ta0>taus[4]] <- taus[4]+0.1
large.df$Ta1[large.df$Ta1>taus[4]] <- taus[4]+0.1
...
save(true.value.tau1, true.value.tau2, true.value.tau3, true.value.tau4, file="true_survival_2.RData") # , f.true.value.tau6
