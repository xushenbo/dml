...
dgp4_true <- function(ntrue){
  ...
  ps <- 1/(1+exp(-(-1+x1+1.5*x2+1.5*x3-x4-1.5*x5-x6))) # 0.3+0.2*x1+0.3*x2+0.3*x3-0.2*x4-0.3*x5-0.2*x6
...
save(true.value.tau1, true.value.tau2, true.value.tau3, true.value.tau4, file="true_competing_8.RData")
